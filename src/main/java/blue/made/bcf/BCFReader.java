...
public class BCFReader {
	 ...
	 * @return true if another item is available, false if this collection (or top level data stream) contains no more
	 * items (END or EOF reached)
	...
	public boolean next() throws IOException {
		if (childInProgress) throw new IllegalStateException("A child of this item is still being read, it must be finished");
